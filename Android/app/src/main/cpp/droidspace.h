...
/* Hardened paths */
#define DS_SELINUX_ENFORCE_PATH "/sys/fs/selinux/enforce"
#define DS_ANDROID_STORAGE_PATH "/storage/emulated/0"
...
#define DS_MIN_KERNEL_MAJOR 5
#define DS_MIN_KERNEL_MINOR 10
#define DS_RECOMMENDED_KERNEL_MAJOR 5
#define DS_RECOMMENDED_KERNEL_MINOR 10
...
struct ds_config {
  ...
  int rootless;           /* --rootless: user namespace mode */
...
void ds_set_workspace_dir(const char *path);
